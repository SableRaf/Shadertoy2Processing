...
// By Shane
// https://www.shadertoy.com/view/Xt3cWl
// Ported to Processing by Raphaël de Courville

// Note: the texture doesn't look quite right
...
void setup() {
  ...
  myShader = loadShader("randomBlockPassage.glsl");
  ...
  pChannel0 = loadImage("rustyMetal.jpg");
}


void draw() {
  
  myShader.set("iChannel0", pChannel0);
